...
from custom_components.addhon._vendor.pyhon.connection.api import HonAPI
from custom_components.addhon._vendor.pyhon.connection.api import TestAPI
from custom_components.addhon._vendor.pyhon.connection.mqtt import MQTTClient
