...
from custom_components.addhon._vendor.pyhon import diagnose, exceptions
from custom_components.addhon._vendor.pyhon.appliances.base import ApplianceBase
from custom_components.addhon._vendor.pyhon.attributes import HonAttribute
from custom_components.addhon._vendor.pyhon.command_loader import HonCommandLoader
from custom_components.addhon._vendor.pyhon.commands import HonCommand
from custom_components.addhon._vendor.pyhon.parameter.base import HonParameter
from custom_components.addhon._vendor.pyhon.parameter.enum import HonParameterEnum
from custom_components.addhon._vendor.pyhon.parameter.range import HonParameterRange
from custom_components.addhon._vendor.pyhon.typedefs import Parameter

if TYPE_CHECKING:
    from custom_components.addhon._vendor.pyhon import HonAPI
    ...
    def __init__(
        ...
        try:
            self._extra: Optional[ApplianceBase] = importlib.import_module(
                f"custom_components.addhon._vendor.pyhon.appliances.{self.appliance_type.lower()}"
            ).Appliance(self)
